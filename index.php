...
<body>
    ...
    <main>
        <div class="main_branca">
            ...
            <p>Somos uma empresa de despache já consolidada no ramo. Estamos prontos para fazer qualquer tipo de
                documentação, emplacamento, enviar 2ª via etc. Sendo assim, seu carros e sua documentação estarão
                seguros em nossas mãos.</p>
        </div>
        <div class="main_azul">
            <img src="./media/eva-azul-bebê.jpg" alt="Teste">
            <h1 class="titulo">O site</h1>
            <p>Esperamos em todos os nossos projetos tirar está dor de cabeça, de mexer com a papelada e a parte mais
                burocrática, dos nossos clientes. <br> Dessa forma, decidimos criar este site, com o intuíto de
                automatizar muitos processos e passar para nosso cliente a profisssionalidade e a segurança de que seu
                automóvel precisa. <br> É possivel <strong>consultar status de pedidos já feitos</strong>, <strong>tirar
                    dúvidas frequentes com nosso chatbot</strong> e <strong>fazer novos pedidos</strong>. Qualquer
                dúvida ou dificuldade, pode nos contatar diretamente pela parte de <strong>atendimento</strong>.</p>
        </div>
        ...
        <div class="main_azul" id="mapa">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3674.99880168831!2d-47.06479938540024!3d-22.913415043867257!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94c8c8cbdac3a855%3A0x703bc03d5ccb4085!2sDespachante%20Central!5e0!3m2!1spt-BR!2sbr!4v1633373107302!5m2!1spt-BR!2sbr"
